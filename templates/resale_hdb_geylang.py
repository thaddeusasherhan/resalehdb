# Analysis for GEYLANG
import pandas as pd
import matplotlib.pyplot as plt

def analyze_town_data(df, town_name='GEYLANG'):
    ...
    plt.title(f'Price per Sqm Range with Median by Month - GEYLANG')
    plt.xlabel('Month')
    ...
    return fig
    #plt.savefig(f"geylang_analysis.png")
    #plt.close()
