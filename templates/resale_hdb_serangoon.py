# Analysis for SERANGOON
import pandas as pd
import matplotlib.pyplot as plt

def analyze_town_data(df, town_name='SERANGOON'):
    ...
    plt.title(f'Price per Sqm Range with Median by Month - SERANGOON')
    plt.xlabel('Month')
    ...
    return fig
    #plt.savefig(f"serangoon_analysis.png")
    #plt.close()
