# Analysis for CENTRAL AREA
import pandas as pd
import matplotlib.pyplot as plt

def analyze_town_data(df, town_name='CENTRAL AREA'):
    ...
    plt.title(f'Price per Sqm Range with Median by Month - CENTRAL AREA')
    plt.xlabel('Month')
    ...
    return fig
    #plt.savefig(f"central_area_analysis.png")
    #plt.close()
