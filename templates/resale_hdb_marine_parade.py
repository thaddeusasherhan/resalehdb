# Analysis for MARINE PARADE
import pandas as pd
import matplotlib.pyplot as plt

def analyze_town_data(df, town_name='MARINE PARADE'):
    ...
    plt.title(f'Price per Sqm Range with Median by Month - MARINE PARADE')
    plt.xlabel('Month')
    ...
    return fig
    #plt.savefig(f"marine_parade_analysis.png")
    #plt.close()
