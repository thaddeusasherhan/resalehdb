# Analysis for BUKIT TIMAH
import pandas as pd
import matplotlib.pyplot as plt

def analyze_town_data(df, town_name='BUKIT TIMAH'):
    ...
    plt.title(f'Price per Sqm Range with Median by Month - BUKIT TIMAH')
    plt.xlabel('Month')
    ...
    return fig
    #plt.savefig(f"bukit_timah_analysis.png")
    #plt.close()
