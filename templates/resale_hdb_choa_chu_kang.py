# Analysis for CHOA CHU KANG
import pandas as pd
import matplotlib.pyplot as plt

def analyze_town_data(df, town_name='CHOA CHU KANG'):
    ...
    plt.title(f'Price per Sqm Range with Median by Month - CHOA CHU KANG')
    plt.xlabel('Month')
    ...
    return fig
    #plt.savefig(f"choa_chu_kang_analysis.png")
    #plt.close()
