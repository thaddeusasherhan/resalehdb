# Analysis for TAMPINES
import pandas as pd
import matplotlib.pyplot as plt


def analyze_town_data(df, town_name='TAMPINES'):
    ...
    plt.title(f'Price per Sqm Range with Median by Month - TAMPINES')
    plt.xlabel('Month')
    ...
    return fig
    #plt.savefig(f"tampines_analysis.png")
    #plt.close()
