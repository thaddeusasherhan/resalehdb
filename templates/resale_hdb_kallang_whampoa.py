# Analysis for KALLANG/WHAMPOA
import pandas as pd
import matplotlib.pyplot as plt

def analyze_town_data(df, town_name='KALLANG/WHAMPOA'):
    ...
    plt.title(f'Price per Sqm Range with Median by Month - KALLANG/WHAMPOA')
    plt.xlabel('Month')
    ...
    return fig
    #plt.savefig(f"kallang_whampoa_analysis.png")
    #plt.close()
