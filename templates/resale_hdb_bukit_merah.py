# Analysis for BUKIT MERAH
import pandas as pd
import matplotlib.pyplot as plt

def analyze_town_data(df, town_name='BUKIT MERAH'):
    ...
    plt.title(f'Price per Sqm Range with Median by Month - BUKIT MERAH')
    plt.xlabel('Month')
    ...
    return fig
    #plt.savefig(f"bukit_merah_analysis.png")
    #plt.close()
