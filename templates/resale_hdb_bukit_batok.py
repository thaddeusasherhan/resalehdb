# Analysis for BUKIT BATOK
import pandas as pd
import matplotlib.pyplot as plt

def analyze_town_data(df, town_name='BUKIT BATOK'):
    ...
    plt.title(f'Price per Sqm Range with Median by Month - BUKIT BATOK')
    plt.xlabel('Month')
    ...
    return fig
    #plt.savefig(f"bukit_batok_analysis.png")
    #plt.close()
