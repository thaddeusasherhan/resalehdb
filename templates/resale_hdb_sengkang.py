# Analysis for SENGKANG
import pandas as pd
import matplotlib.pyplot as plt

def analyze_town_data(df, town_name='SENGKANG'):
    ...
    plt.title(f'Price per Sqm Range with Median by Month - SENGKANG')
    plt.xlabel('Month')
    ...
    return fig
    #plt.savefig(f"sengkang_analysis.png")
    #plt.close()
