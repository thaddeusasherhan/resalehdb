# Analysis for BUKIT PANJANG
import pandas as pd
import matplotlib.pyplot as plt

def analyze_town_data(df, town_name='BUKIT PANJANG'):
    ...
    plt.title(f'Price per Sqm Range with Median by Month - BUKIT PANJANG')
    plt.xlabel('Month')
    ...
    return fig
    #plt.savefig(f"bukit_panjang_analysis.png")
    #plt.close()
