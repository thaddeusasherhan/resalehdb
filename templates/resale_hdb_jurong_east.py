# Analysis for JURONG EAST
import pandas as pd
import matplotlib.pyplot as plt

def analyze_town_data(df, town_name='JURONG EAST'):
    ...
    plt.title(f'Price per Sqm Range with Median by Month - JURONG EAST')
    plt.xlabel('Month')
    ...
    return fig
    #plt.savefig(f"jurong_east_analysis.png")
    #plt.close()
